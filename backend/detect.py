...
def run(
        ...
        source=ROOT / 'uploads',  # file/dir/URL/glob, 0 for webcam
        data=ROOT / 'data/fruit.yaml',  # dataset.yaml path
        ...
        project=ROOT / 'tmp',  # save results to project/name
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT /
                        'uploads', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT /
                        'data/yolov5l.yaml', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT /
                        'tmp', help='save results to project/name')
